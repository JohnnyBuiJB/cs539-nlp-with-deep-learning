...
def main_glove():
    ...
    maxEpoch = 40        # maximum number of epochs
                ...
                for epoch in range(maxEpoch):
                    ...
                    for b in range(idx.shape[0]//B+1):
                        ...
                        if b % 100 == 0 and b > 0:
                            ...
                            loss_per_epoch.append(loss/(B*100))
                            loss = 0
                
                with open("%d_%d_%.02f_loss.csv" % (B,d,learningRate), "w") as file:
                    w = csv.writer(file)
                    w.writerow(loss_per_epoch)
